...
<head>
  ...
  <script>
   function onSubmit(token) {
     document.getElementById("log_user").submit();
   }
 </script>
</head>
<style>
...
<body class="container">
  ...
  <form method="post" action="login.php">
  	...
  	<div class="input-group">
  		...
  		<centre><input type="text" name="username" ></centre>
  	</div>
  	<div class="input-group">
  		<centre><label>Password</label></centre>
  		<centre><input type="password" name="password"></centre>
  	</div>
	<div>
	<br>
	<br>
...
<input type="radio" name="radio3" value="48"><img src="4.8.jpg"alt="random" width="100" height="100">
	  ...
	  <p>
  		Forgot Password?  <a href="contact.html">Reset Password</a>
  	</p>
